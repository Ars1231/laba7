...
int main() {
    Groups groups;
    Student student1 = {"Arseniy Potapov", 1, {{"Math", Good}, {"Physics", Excellent}}};
    Student student2 = {"Vitalii Nalivkin", 1, {{"Math", Unsatisfactorily}, {"Physics", Good}}};
    Student student3 = {"Vasilii Naiidenov", 1, {{"Math", Excellent}, {"Physics", Unsatisfactorily}}};
